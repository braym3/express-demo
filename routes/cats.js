...
router.patch('/update/:id', async (req, res, next) => {
  try {
    ...
    const updatedCat = await catModel.findByIdAndUpdate(id, req.query, { returnDocument: 'after' }); // update by id using query params - by default returns document before you replace it - change to return after
